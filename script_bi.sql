...
INNER JOIN BI_SYSTEAM.BI_RANGO_M2 birm2 ON  i.INMUEBLE_SUPERFICIETOTAL BETWEEN  birm2.METROS2_MINIMO AND birm2.METROS2_MAXIMO  --tengo m2
...
INNER JOIN BI_SYSTEAM.BI_TIEMPO bitie ON bitie.TIEMPO_ANIO = year(v.VENTA_FECHA) AND bitie.TIEMPO_MES = month(v.VENTA_FECHA) AND bitie.TIEMPO_DIA = day(v.VENTA_FECHA)
