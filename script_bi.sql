...
SELECT DISTINCT
	...
	COUNT(*),                       -- CANT ALQUILER
	(CASE WHEN pa.PAGO_ALQUILER_FECHA >= pa.PAGO_ALQUILER_FECHA_VENCIMIENTO THEN 1 ELSE 0 END),
	(CASE WHEN pa.PAGO_ALQUILER_FECHA <= pa.PAGO_ALQUILER_FECHA_VENCIMIENTO THEN 1 ELSE 0 END)
...
CREATE VIEW BI_SYSTEAM.VISTA_PROMEDIO_DIAS_PUBLICADOS_ANUNCIOS AS 
	SELECT 
		...
		a.ANUNCIO_DIAS_PUBLICADO						AS [Duracion promedio en dias]
	FROM
...
CREATE VIEW BI_SYSTEAM.VISTA_PROMEDIO_ANUNCIOS_INMUEBLES AS
	SELECT 
		...
		a.ANUNCIO_PRECIO							AS [Precio promedio],
