...
SELECT DISTINCT
	...
	COUNT(NULLIF(CASE WHEN pa.PAGO_ALQUILER_FECHA > pa.PAGO_ALQUILER_FECHA_VENCIMIENTO THEN a.ALQUILER_CODIGO END, 0)) AS PAGOS_ATRASADOS,
	COUNT(NULLIF(CASE WHEN pa.PAGO_ALQUILER_FECHA <= pa.PAGO_ALQUILER_FECHA_VENCIMIENTO THEN a.ALQUILER_CODIGO END, 0)) AS PAGOS_EN_TERMINO
