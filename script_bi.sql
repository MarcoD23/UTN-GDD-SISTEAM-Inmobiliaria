...
IF OBJECT_ID('BI_SYSTEAM.CARGAR_BI_RANGO_M2') IS NOT NULL
	DROP PROCEDURE BI_SYSTEAM.CARGAR_DIM_RANGO_M2
GO

IF OBJECT_ID ('BI_SYSTEAM.CARGAR_BI_INMUEBLE') IS NOT NULL
	DROP PROCEDURE BI_SYSTEAM.CARGAR_BI_INMUEBLE
GO
...
IF OBJECT_ID ('BI_SYSTEAM.CARGAR_FACT_VENTA') IS NOT NULL
	DROP PROCEDURE BI_SYSTEAM.CARGAR_FACT_VENTA
GO
...
CREATE PROCEDURE BI_SYSTEAM.BI_CARGAR_FACT_ALQUILER
AS
BEGIN
...
CREATE PROCEDURE BI_SYSTEAM.BI_CARGAR_TIPO_OPERACION
AS
BEGIN
INSERT INTO PIE_SYSTEAM.BI_TIPO_OPERACION
SELECT DISTINCT
	t.TIPO_OPERACION_DESCRIPCION
FROM SYSTEAM.TIPO_OPERACION t
END
GO

CREATE PROCEDURE SYSTEAM.BI_CARGAR_AMBIENTES
AS
BEGIN
INSERT INTO PIE_DERECHO.BI_TIPO_OPERACION
SELECT DISTINCT
	a.AMBIENTES_DESCRIPCION
FROM SYSTEAM.AMBIENTES a
END
GO

CREATE PROCEDURE SYSTEAM.BI_CARGAR_SUCURSAL
AS
BEGIN
INSERT INTO PIE_DERECHO.BI_TIEMPO
SELECT DISTINCT
	s.SUCURSAL_NOMBRE
FROM SYSTEAM.SUCURSAL s
END
GO

CREATE PROCEDURE BI_SYSTEAM.BI_CARGAR_BI_TIPO_MONEDA
AS
BEGIN
...
EXEC CARGAR_BI_TIPO_MONEDA
EXEC CARGAR_BI_TIPO_INMUEBLE
EXEC CARGAR_BI_RANGO_M2
EXEC CARGAR_BI_RANGO_ETARIO
EXEC CARGAR_BI_SUCURSAL
