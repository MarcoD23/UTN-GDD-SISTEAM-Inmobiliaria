...
CREATE TABLE BI_SYSTEAM.BI_FACT_ANUNCIO (
	ID_TIPO_INMUEBLE NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIPO_INMUEBLE,
	ID_RANGO_M2 NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_RANGO_M2,
    ID_TIEMPO_FECHA_PUBLICACION NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
    ID_TIEMPO_FECHA_FINALIZACION NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
    ID_TIPO_OPERACION NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIPO_OPERACION,
	ID_AMBIENTES NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_AMBIENTES,
	ID_SUCURSAL NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_SUCURSAL,
	ID_TIPO_MONEDA NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIPO_MONEDA,
	ID_UBICACION NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_UBICACION,
	ID_RANGO_ETARIO NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_RANGO_ETARIO,
...
CREATE TABLE BI_SYSTEAM.BI_FACT_VENTA (
	ID_TIPO_INMUEBLE NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIPO_INMUEBLE,
	ID_RANGO_M2 NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_RANGO_M2,
    ID_TIEMPO_FECHA NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
	ID_TIPO_MONEDA NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIPO_MONEDA,
	ID_UBICACION NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_UBICACION,
...
CREATE TABLE BI_SYSTEAM.BI_FACT_ALQUILER (
    ID_TIEMPO_FECHA_INICIO NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
    ID_TIEMPO_FECHA_FIN NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
	ID_TIEMPO_FECHA_PAGO NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
	ID_TIEMPO_FECHA_VENCIMIENTO NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIEMPO,
	ID_TIPO_MONEDA NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_TIPO_MONEDA,
	ID_UBICACION NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_UBICACION,
	ID_RANGO_ETARIO NUMERIC(18,0) FOREIGN KEY REFERENCES BI_SYSTEAM.BI_RANGO_ETARIO,
