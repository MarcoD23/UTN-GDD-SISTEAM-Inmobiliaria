...
CREATE TABLE BI_SYSTEAM.BI_FACT_VALOR_ALQUILER (
    ID_FACT_VALOR_ALQUILER INT IDENTITY(1,1) PRIMARY KEY,
    MONTO_ANTERIOR INT,
    MONTO_NUEVO INT,
);
GO

CREATE TABLE BI_SYSTEAM.BI_FACT_PAGO_ALQUILER (
    ID_FACT_PAGO_ALQUILER INT IDENTITY(1,1) PRIMARY KEY,
    FECHA_PAGO DATE,
